...
Esta semana se me ocurrió volver a hacer una tarea de la universidad que me gusta mucho. Crear un programa en el que se pueda subadministrar un pedazo de memoria.
...
Al incializar nuestro programa, pediremos al sistema que nos reserve cualquier cantidad de bytes. Para hacer esto creé un tipo de dato byte, que a final de cuentas es un entero de 8 bits sin signo. Y para almacenar la direccion de inicio de nuestro segmento, creé un apuntador de tipo byte, `memoria`.
{% highlight c %}
// memoria.h
